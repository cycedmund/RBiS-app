...
const DateBadge = ({ unit }) => {
  return (
    <div className="flex flex-wrap items-center">
      <span className="bg-gray-100 text-gray-800 text-xs md:text-sm font-roboto font-normal px-1 py-0.5 rounded dark:bg-stone-700 dark:text-gray-200 border border-gray-500">
